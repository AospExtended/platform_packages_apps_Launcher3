...
import com.aosp.launcher.search.nano.SearchProto.Columns;
import com.aosp.launcher.search.nano.SearchProto.AppIndex;
import com.aosp.launcher.search.nano.SearchProto.SearchBase;
import com.aosp.launcher.search.nano.SearchProto.SearchView;
...
public class ConfigurationBuilder {
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(AospLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
