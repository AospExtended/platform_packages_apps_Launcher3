...
public class HotseatQsbContainer extends Hotseat {
    ...
    public void onDraw(Canvas canvas) {
        if (mIsTransposed && mAllAppsQsb != null) {
            ...
            if (mWidth <= 0) {
                mWidth = mAllAppsQsb.calculateMeasuredDimension(mActivity.getDeviceProfile(), Math.round(((float) dp.iconSizePx) * 0.92f), MeasureSpec.makeMeasureSpec(getWidth(), MeasureSpec.EXACTLY));
            }
