...
public class DefaultQsbContainer extends ExtendedEditText implements OnUpdateListener, Callbacks, SearchUiManager {
    ...
    @Override
    public EditText setTextSearchEnabled(boolean enable) {
        EditText editText = Launcher.getLauncher(getContext()).getAppsView().getSearchUiManager().setTextSearchEnabled(true);
        return editText;
    };
