    ...
    public void startService(View view) {
        ...
        if (mOpaEnabled) {
            ...
            if (hasGoogleApp) {
                ...
                opt.putInt(AssistantInputConsumer.OPA_BUNDLE_TRIGGER, 37);
                opt.putInt(AssistantInputConsumer.INVOCATION_TYPE_KEY, 4);
        ...
        try {
            ...
            context.getSystemService(LauncherApps.class).startAppDetailsActivity(new ComponentName("com.google.android.googlequicksearchbox", ".SearchActivity"), Process.myUserHandle(), null, null);
        }
    }
