package com.aospextended.launcher.smartspace;
...
public class SmartSpaceHostView extends QsbWidgetHostView implements View.OnLongClickListener, BaseDragLayer.TouchCompleteListener {
    ...
    public boolean onLongClick(View v) {
        ...
        OptionsPopupView.OptionItem item = new OptionsPopupView.OptionItem(getContext(),
        ...
        OptionsPopupView.show(mLauncher, rectF, Collections.singletonList(item), false);
        return true;
    }
