...
import com.aospextended.launcher.qsb.AllAppsQsbContainer;
import com.aospextended.launcher.search.nano.SearchProto.Columns;
import com.aospextended.launcher.search.nano.SearchProto.AppIndex;
import com.aospextended.launcher.search.nano.SearchProto.SearchBase;
import com.aospextended.launcher.search.nano.SearchProto.SearchView;
...
public class ConfigurationBuilder {
    ...
    public ConfigurationBuilder(AllAppsQsbContainer qsbContainer, boolean isAllApps) {
        ...
        mUserManager = UserCache.INSTANCE.get(mLauncher);
    }
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(CustomLauncher.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
    ...
    public int getBackgroundColor() {
        return ColorUtils.compositeColors(Themes.getAttrColor(mLauncher, R.attr.allAppsScrimColor), 
                ColorUtils.setAlphaComponent(WallpaperColorInfo.INSTANCE.get(mLauncher).getMainColor(), 255));
    }
